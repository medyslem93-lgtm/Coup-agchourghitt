(() => {
  ...
  style.textContent = `
    ...
    .agh-tow-slot b{font-size:11px!important;text-shadow:0 2px 5px #000}.agh-tow-slot small{color:#dfff00!important;font-size:9px!important}.agh-tow-team-logo{width:25px!important;height:25px!important;border:2px solid #fff!important}
    ...
    @media(max-width:600px){.agh-tow-page{padding-inline:8px!important}.agh-tow-hero{padding:20px 16px!important}.agh-tow-hero h1{font-size:23px!important}.agh-tow-admin-band{align-items:flex-start;flex-direction:column}.agh-tow-pitch{min-height:555px!important;padding-inline:2px!important}.agh-tow-lines{min-height:510px!important}.agh-tow-slot{width:clamp(44px,17vw,67px)!important;min-height:96px!important}.agh-tow-player-disc{width:clamp(39px,13.5vw,56px)!important;height:clamp(39px,13.5vw,56px)!important}.agh-tow-slot b{font-size:9px!important}.agh-tow-slot small{font-size:8px!important}.agh-tow-toolbar{grid-template-columns:minmax(0,1fr) auto!important}.agh-tow-status{font-size:10px!important;padding:10px!important}}
  `;
