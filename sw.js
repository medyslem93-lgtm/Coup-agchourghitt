const C='agchorguit-live-v29';
const CORE=['./','index.html','styles.css','match-v2.css','prediction-league.css','matches-reference.css','matches-reference-patch.css','middle-section.css','middle-section-patch.css','world-ui.css','config.js','public-app.js','media-enhancer.js','prediction-league.js','match-details-v2.js','matches-reference.js','score-display-fix.js','middle-section.js','middle-section-patch.js','middle-watchdog.js','image-fallback.js','world-ui.js','runtime-health.js','manifest.webmanifest','assets/tournament.jpg','assets/logo-placeholder.svg'];
