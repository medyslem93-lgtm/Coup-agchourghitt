const C='agchorguit-live-v36';
const CORE=['./','index.html','styles.css','match-v2.css','match-pane-fix.css','prediction-league.css','matches-reference.css','matches-reference-patch.css','middle-section.css','middle-section-patch.css','world-ui.css','site-health.css','visual-polish.css','config.js','public-app.js','media-enhancer.js','prediction-league.js','prediction-verification-patch.js','match-details-v2.js','referee-photos.js','matches-reference.js','score-display-fix.js','middle-section.js','middle-section-patch.js','middle-watchdog.js','image-fallback.js','world-ui.js','runtime-health.js','site-health.js','ui-polish.js','manifest.webmanifest','assets/tournament.jpg','assets/logo-placeholder.svg'];
