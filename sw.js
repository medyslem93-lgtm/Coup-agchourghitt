const C='agchorguit-live-v10';
const CORE=['./','index.html','styles.css','config.js','public-app.js','media-enhancer.js','match-details-v2.js','manifest.webmanifest','assets/tournament.jpg'];
