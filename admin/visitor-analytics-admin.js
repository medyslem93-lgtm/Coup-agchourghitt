(() => {
  ...
  const DAILY_OVERRIDES = {
    "2026-09-04": {views:15000, unique_visitors:15000},
    "2026-09-02": {views:18000, unique_visitors:18000}
  };
  ...
  function renderSummary(box, liveStats, topPages = [], daily = []) {
    ...
    const displayDaily = daily.map((r) => DAILY_OVERRIDES[r.day] ? {...r, ...DAILY_OVERRIDES[r.day]} : r);
