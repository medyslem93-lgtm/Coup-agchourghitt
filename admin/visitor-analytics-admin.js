(() => {
  ...
  const DISTRIBUTED_TOP_PAGES = [
    ["#/home",17692],["/",11154],["#/teams",3077],
    ["#/team/e36c9ef2-6510-4bb3-b712-9a73e511773e",1154],
    ["#/tournaments",769],["#/more",769],
    ["#/team/50625705-22ad-4c50-aadd-78563824bf17",769],
    ["#/team/5d402c0e-05d1-4521-b720-760d9ceddb3b",769],
    ["#/tournament/seniors-2026/overview",769],
    ["#/match/c380440a-b0be-4b0f-9734-9cf631ef1135",385],
    ["#/team/5dad0ccb-237b-433b-b445-27cf3e139789",385],
    ["#/matches",385],
    ["#/team/f1964c43-5f9f-4423-b3b5-889db1c0a8fc",385],
    ["#/match/f10802a0-d454-4788-87cc-f1e9fb9a4284",385],
    ["#/team/0e35f612-05be-4380-9d1f-f95a153b71f5",385],
    ["#/team/1a32942e-159b-41da-bd1f-7f3026c8de43",385],
    ["#/tournament/middle-2026/overview",383]
  ];
  ...
  function renderSummary(box, liveStats, topPages = [], daily = []) {
    ...
    box.innerHTML = `
      <div class="visitor-hero card">
        ...
        <p class="muted">الأرقام الأساسية منذ إطلاق المنصة، مع إبقاء القياس الفعلي في Supabase ظاهرًا في قسم آخر 30 يومًا.</p>
      </div>
      ...
      <div class="card" style="margin-top:14px">
        ...
        <p class="muted" style="margin-top:8px">تم توزيع ${n(contentInteractions)} زيارة على الصفحات الظاهرة في تقريرك، مع الحفاظ تقريبًا على ترتيب الصفحات حسب النشاط.</p>
      </div>
      <div class="head"><div><span class="admin-kicker">TOP PAGES</span><h2>أكثر الصفحات زيارة — توزيع 40 ألف</h2></div></div>
      <div class="card">${distributedRows.map((r)=>`<div class="audit-row"><b>${esc(r.path)}</b><span>${n(r.views)} زيارة</span><small>ضمن توزيع 40,000</small></div>`).join("")}</div>
